...
namespace DataSheetTypes{
	...
	public class SheetTest: IEnumerable{
		public System.DateTime updated = new System.DateTime(2020,5,15,19,58,7);
		...
		public void Init() {
			_rows = new Test[]{
					...
					new Test(101,"Card_Piranhas_Feet","The Zoo","Card_Background","Piranhas graze your legs but do not attack you. \n\nThe man looks at you strangely while asking you to come out.","_animalerie","Piranhas",false,"none",false,0,"","_none","none",107,"Grab and bite a piranha","","none",102,"Thorw a piranha to the cleaner's head","","none",false,false,100,false,"",0,"",""),
					...
					new Test(103,"Card_Piranhas_CleanerQuestion","The Zoo","Card_Background","\"What do you want, sir ?\"","_animalerie","Piranhas",false,"none",false,0,"","_none","none",108,"Shove him and try to take a fish","","none",104,"Give me one of those fish","","none",false,false,100,false,"",0,"",""),
